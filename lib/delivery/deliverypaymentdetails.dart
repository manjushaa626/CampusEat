...
class deliverypaymentdetails extends StatelessWidget {
  const deliverypaymentdetails({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection('order_details').where('orderType', isEqualTo: 'Delivery').snapshots(),
